...
class Ui_TagSorter(object):
    def setupUi(self, TagSorter):
        ...
        self.emptyFolderCleanButton = QtWidgets.QPushButton(TagSorter)
        self.emptyFolderCleanButton.setObjectName("emptyFolderCleanButton")
        self.gridLayout_2.addWidget(self.emptyFolderCleanButton, 5, 2, 1, 1)
    ...
    def retranslateUi(self, TagSorter):
        ...
        self.emptyFolderCleanButton.setText(_translate("TagSorter", "Clean empty folders"))
